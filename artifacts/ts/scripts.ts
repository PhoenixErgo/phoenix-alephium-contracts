...
import { default as ChangeContractCreationALPHScriptJson } from "../ChangeContractCreationALPH.ral.json";
...
import { default as ChangeMinValueDivisorScriptJson } from "../ChangeMinValueDivisor.ral.json";
...
export const ChangeContractCreationALPH = new ExecutableScript<{
  factory: HexString;
  newContractCreationALPH: bigint;
}>(Script.fromJson(ChangeContractCreationALPHScriptJson, ""));
...
export const ChangeMinValueDivisor = new ExecutableScript<{
  factory: HexString;
  newMinValueDivisor: bigint;
}>(Script.fromJson(ChangeMinValueDivisorScriptJson, ""));
